...
for (var i = 0; i < buttons.length; i++) {
	...
	sheet.innerHTML = sheet.innerHTML + "#" + buttons[i].id + " {text-shadow:0px 1px 0px hsla(" + hsl[0] + ", " + hsl[1] + "%, " + (hsl[2]-20) + "%, 1);border:2px solid hsla(" + hsl[0] + ", " + hsl[1] + "%, " + (hsl[2]-20) + "%, 1);background:linear-gradient(to bottom, hsla(" + hsl[0] + ", " + hsl[1] + "%, " + (hsl[2]+10) + "%, 1) 5%, hsla(" + hsl[0] + ", " + hsl[1] + "%, " + (hsl[2]-10) + "%, 1) 100%)}\r" + 
